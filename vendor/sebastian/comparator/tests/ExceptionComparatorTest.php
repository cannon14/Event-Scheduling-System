...
class ExceptionComparatorTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		return array(array(new Exception, new Exception), array(new RuntimeException, new RuntimeException), array(new Exception, new RuntimeException));
	}

	public function acceptsFailsProvider()
	{
		return array(array(new Exception, null), array(null, new Exception), array(null, null));
	}
	...
	public function assertEqualsSucceedsProvider()
	{
		...
		return array(array($exception1, $exception1), array($exception1, $exception2), array($exception3, $exception3), array($exception3, $exception4));
	}
	...
	public function assertEqualsFailsProvider()
	{
		...
		return array(array($exception1, $exception2, $equalMessage), array($exception1, $exception3, $equalMessage), array($exception1, $exception4, $typeMessage), array($exception2, $exception3, $equalMessage), array($exception4, $exception5, $equalMessage));
	}
