...
class SplObjectStorageComparatorTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		return array(array(new SplObjectStorage, new stdClass), array(new stdClass, new SplObjectStorage), array(new stdClass, new stdClass));
	}
	...
	public function assertEqualsSucceedsProvider()
	{
		...
		return array(array($storage1, $storage1), array($storage1, $storage2), array($storage3, $storage3), array($storage3, $storage4));
	}
	...
	public function assertEqualsFailsProvider()
	{
		...
		return array(array($storage1, $storage2), array($storage1, $storage3), array($storage2, $storage3),);
	}
