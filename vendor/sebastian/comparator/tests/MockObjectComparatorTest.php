...
class MockObjectComparatorTest extends \PHPUnit_Framework_TestCase
{
	...
	public function acceptsSucceedsProvider()
	{
		...
		return array(array($testmock, $testmock), array($stdmock, $stdmock), array($stdmock, $testmock));
	}
	...
	public function acceptsFailsProvider()
	{
		...
		return array(array($stdmock, null), array(null, $stdmock), array(null, null));
	}
	...
	public function assertEqualsSucceedsProvider()
	{
		...
		return array(array($object1, $object1), array($object1, $object2), array($book1, $book1), array($book1, $book2), array($this->getMock('SebastianBergmann\\Comparator\\Struct', null, array(2.3)), $this->getMock('SebastianBergmann\\Comparator\\Struct', null, array(2.5)), 0.5));
	}
