...
class HipChatHandler extends SocketHandler
{
	...
	{
		$dataArray = array('from' => $this->name, 'room_id' => $this->room, 'notify' => $this->notify, 'message' => $record['formatted'], 'message_format' => $this->format, 'color' => $this->getAlertColor($record['level']),);
	...
	private function combineRecords($records)
	{
		...
		foreach ($records as $record) {
			...
			$batchRecord = array('message' => $messgeStr, 'formatted' => $formattedMessageStr, 'context' => array(), 'extra' => array(),);
