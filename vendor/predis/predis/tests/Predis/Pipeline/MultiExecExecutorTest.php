...
class MultiExecExecutorTest extends PredisTestCase
{
	...
	public function testExecutorWithSingleConnection()
	{
		...
		$connection->expects($this->exactly(2))->method('executeCommand')->will($this->onConsecutiveCalls(true, array('PONG', 'PONG', 'PONG')));
	...
	public function testExecutorWithErrorInCommandResponse()
	{
		...
		$connection->expects($this->at(7))->method('executeCommand')->will($this->returnValue(array('PONG', 'PONG', $error)));
