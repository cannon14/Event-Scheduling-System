...
class ConnectionParametersTest extends PredisTestCase
{
	...
	public function testParsingURI()
	{
		...
		$expected = array('scheme' => 'tcp', 'host' => '10.10.10.10', 'port' => 6400, 'timeout' => '0.5', 'persistent' => '1',);
	...
	public function testParsingUnixDomainURI()
	{
		...
		$expected = array('scheme' => 'unix', 'host' => 'localhost', 'path' => '/tmp/redis.sock', 'timeout' => '0.5', 'persistent' => '1',);
	...
	public function testParsingURIWithIncompletePairInQueryString()
	{
		...
		$expected = array('scheme' => 'tcp', 'host' => '10.10.10.10', 'persistent' => '1', 'foo' => '', 'bar' => '',);
	...
	public function testParsingURIWithMoreThanOneEqualSignInQueryStringPairValue()
	{
		...
		$expected = array('scheme' => 'tcp', 'host' => '10.10.10.10', 'foobar' => 'a=b=c', 'persistent' => '1',);
	...
	public function testParsingURIWhenQueryStringHasBracketsInFieldnames()
	{
		...
		$expected = array('scheme' => 'tcp', 'host' => '10.10.10.10', 'persistent' => '1', 'metavars' => array('foo', 'hoge'),);
	...
	{
		return array('scheme' => 'tcp', 'host' => '127.0.0.1', 'port' => 6379, 'timeout' => 5.0,);
	}
