...
class ClientTest extends PredisTestCase
{
	...
	{
		$arg1 = array(array('host' => 'localhost', 'port' => 7000), array('host' => 'localhost', 'port' => 7001),);
	...
	public function testExecuteCommandReturnsParsedReplies()
	{
		...
		$connection->expects($this->at(1))->method('executeCommand')->with($hgetall)->will($this->returnValue(array('foo', 'bar', 'hoge', 'piyo')));
