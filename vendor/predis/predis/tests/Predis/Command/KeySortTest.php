...
class KeySortTest extends PredisCommandTestCase
{
	...
	{
		$modifiers = array('by' => 'by_key_*', 'limit' => array(1, 4), 'get' => array('object_*', '#'), 'sort' => 'asc', 'alpha' => true, 'store' => 'destination_key',);
		$arguments = array('key', $modifiers);

		$expected = array('key', 'BY', 'by_key_*', 'GET', 'object_*', 'GET', '#', 'LIMIT', 1, 4, 'ASC', 'ALPHA', 'STORE', 'destination_key');
	...
	public function testPrefixKeys()
	{
		...
		$expected = array('prefix:key', 'BY', 'prefix:by_key_*', 'GET', 'prefix:object_*', 'GET', '#', 'LIMIT', 1, 4, 'ASC', 'ALPHA', 'STORE', 'prefix:destination_key');
	...
	public function testSortWithAscOrDescModifier()
	{
		...
		$this->assertEquals(array(100, 30, 10, 3, 2, 1), $redis->sort('list:unordered', array('sort' => 'desc',)));

		$this->assertEquals(array(1, 2, 3, 10, 30, 100), $redis->sort('list:unordered', array('sort' => 'asc',)));
	}
	...
	public function testSortWithLimitModifier()
	{
		...
		$this->assertEquals(array(1, 2, 3), $redis->sort('list:unordered', array('limit' => array(0, 3),)));

		$this->assertEquals(array(10, 30), $redis->sort('list:unordered', array('limit' => array(3, 2))));
	}
	...
	public function testSortWithAlphaModifier()
	{
		...
		$this->assertEquals(array(1, 10, 100, 2, 3, 30), $redis->sort('list:unordered', array('alpha' => true)));
	}
	...
	public function testSortWithStoreModifier()
	{
		...
		$this->assertEquals(count($unordered), $redis->sort('list:unordered', array('store' => 'list:ordered')));
	...
	public function testSortWithCombinedModifiers()
	{
		...
		$this->assertEquals(array(30, 10, 3, 2), $redis->sort('list:unordered', array('alpha' => false, 'sort' => 'desc', 'limit' => array(1, 4))));
	}
	...
	public function testSortWithGetModifiers()
	{
		...
		$redis->mset($sortget = array('uid:1000' => 'foo', 'uid:1001' => 'bar', 'uid:1002' => 'hoge', 'uid:1003' => 'piyo',));
