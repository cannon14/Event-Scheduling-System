...
class ClientOptionsTest extends PredisTestCase
{
	...
	{
		$options = new ClientOptions(array('cluster' => 'Predis\Connection\PredisCluster', 'connections' => 'Predis\Connection\ConnectionFactory', 'prefix' => 'prefix:', 'profile' => '2.0', 'exceptions' => false,));
	...
	{
		$options = new ClientOptions(array('custom' => 'foobar',));
	...
	{
		$options = new ClientOptions();
		$option = new CustomOption(array('default' => function ($options) {
			return 'foo';
		},));
