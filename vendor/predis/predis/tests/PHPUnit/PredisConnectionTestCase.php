...
abstract class PredisConnectionTestCase extends PredisTestCase
{
	...
	public function testSendsInitializationCommandsOnConnection()
	{
		...
		$cmdEcho->expects($this->once())->method('getArguments')->will($this->returnValue(array('ECHOED')));
	...
	{
		return array('scheme' => 'tcp', 'host' => REDIS_SERVER_HOST, 'port' => REDIS_SERVER_PORT, 'database' => REDIS_SERVER_DBNUM, 'read_write_timeout' => 2,);
	}
