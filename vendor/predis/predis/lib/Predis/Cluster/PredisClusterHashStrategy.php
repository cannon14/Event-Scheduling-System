...
class PredisClusterHashStrategy implements CommandHashStrategyInterface
{
	...
	protected function getDefaultCommands()
	{
		...
		return array(/* commands operating on the key space */
