...
class ClientOptions implements ClientOptionsInterface
{
	...
	{
		return array('profile' => new ClientProfile(), 'connections' => new ClientConnectionFactory(), 'cluster' => new ClientCluster(), 'replication' => new ClientReplication(), 'prefix' => new ClientPrefix(), 'exceptions' => new ClientExceptions(),);
	}
