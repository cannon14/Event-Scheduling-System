...
class ConnectionParameters implements ConnectionParametersInterface
{
	...
	{
		return array('port' => 'self::castInteger', 'async_connect' => 'self::castBoolean', 'persistent' => 'self::castBoolean', 'timeout' => 'self::castFloat', 'read_write_timeout' => 'self::castFloat', 'iterable_multibulk' => 'self::castBoolean',);
	}
