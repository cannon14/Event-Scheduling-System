...
class PHP_Token_InterfaceTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$this->assertEquals(array('b'), $this->class->getInterfaces());
	}
	...
	{
		return array(array(TEST_FILES_PATH . 'multipleNamespacesWithOneClassUsingBraces.php'), array(TEST_FILES_PATH . 'multipleNamespacesWithOneClassUsingNonBraceSyntax.php'),);
	}
