...
class PHP_Token_IncludeTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$this->assertSame(array('test4.php', 'test3.php', 'test2.php', 'test1.php'), $this->ts->getIncludes());
	}
	...
	{
		$this->assertSame(array('require_once' => array('test4.php'), 'require' => array('test3.php'), 'include_once' => array('test2.php'), 'include' => array('test1.php')), $this->ts->getIncludes(TRUE));
	}
	...
	{
		$this->assertSame(array('test4.php'), $this->ts->getIncludes(TRUE, 'require_once'));
	}
}
