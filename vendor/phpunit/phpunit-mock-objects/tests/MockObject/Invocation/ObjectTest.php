...
class Framework_MockObject_Invocation_ObjectTest extends PHPUnit_Framework_TestCase
{
	...
	{
		new PHPUnit_Framework_MockObject_Invocation_Object('FooClass', 'FooMethod', array('an_argument'), new StdClass);
	}

	public function testAllowToGetClassNameSetInConstructor()
	{
		$invocation = new PHPUnit_Framework_MockObject_Invocation_Object('FooClass', 'FooMethod', array('an_argument'), new StdClass);
	...
	public function testAllowToGetObjectSetInConstructor()
	{
		...
		$invocation = new PHPUnit_Framework_MockObject_Invocation_Object('FooClass', 'FooMethod', array('an_argument'), $expectedObject);
	...
	public function testConstructorAllowToSetFlagCloneObjectsInParameters()
	{
		...
		$invocation = new PHPUnit_Framework_MockObject_Invocation_Object('FooClass', 'FooMethod', $parameters, new StdClass, $cloneObjects);
