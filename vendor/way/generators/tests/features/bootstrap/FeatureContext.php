...
class FeatureContext extends BehatContext
{
	...
	public function iGenerateAMigrationWithNameAndFields($migrationName, $fields)
	{
		...
		$this->tester->execute(['migrationName' => $migrationName, '--fields' => $fields, '--testing' => true, '--path' => __DIR__ . '/../../tmp', '--templatePath' => __DIR__ . '/../../../src/Way/Generators/templates/migration.txt']);
	}
	...
	public function iGenerateAModelWith($modelName)
	{
		...
		$this->tester->execute(['modelName' => $modelName, '--path' => __DIR__ . '/../../tmp', '--templatePath' => __DIR__ . '/../../../src/Way/Generators/templates/model.txt']);
	}
	...
	public function iGenerateAControllerWith($controllerName)
	{
		...
		$this->tester->execute(['controllerName' => $controllerName, '--path' => __DIR__ . '/../../tmp', '--templatePath' => __DIR__ . '/../../../src/Way/Generators/templates/controller.txt']);
	}
	...
	public function iGenerateAViewWith($viewName)
	{
		...
		$this->tester->execute(['viewName' => $viewName, '--path' => __DIR__ . '/../../tmp', '--templatePath' => __DIR__ . '/../../../src/Way/Generators/templates/view.txt']);
	}
	...
	public function iGenerateASeedWith($tableName)
	{
		...
		$this->tester->execute(['tableName' => $tableName, '--path' => __DIR__ . '/../../tmp', '--templatePath' => __DIR__ . '/../../../src/Way/Generators/templates/seed.txt']);
