...
class PHPParser_Tests_NodeAbstractTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$attributes = array('startLine' => 10, 'comments' => array(new PHPParser_Comment('// Comment' . "\n"), new PHPParser_Comment_Doc('/** doc comment */'),),);

		$node = $this->getMockForAbstractClass('PHPParser_NodeAbstract', array(array('subNode' => 'value'), $attributes), 'PHPParser_Node_Dummy');
