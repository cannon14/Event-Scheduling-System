...
class PHPParser_Tests_NodeDumperTest extends PHPUnit_Framework_TestCase
{
    ...
    1: Bar
    Key: FooBar
)'), array(new PHPParser_Node_Name(array('Hallo', 'World')), 'Name(
    parts: array(
        0: Hallo
        1: World
    )
)'), array(new PHPParser_Node_Expr_Array(array(new PHPParser_Node_Expr_ArrayItem(new PHPParser_Node_Scalar_String('Foo')))), 'Expr_Array(
    items: array(
        0: Expr_ArrayItem(
            key: null
            value: Scalar_String(
