...
(function (O, Y, s) {
    ...
    function r(b, a, c) {
        var d, e;
        if (b)if (F(b))for (d in b)"prototype" == d || "length" == d || "name" == d || b.hasOwnProperty && !b.hasOwnProperty(d) || a.call(c, b[d], d, b); else if (M(b) || Na(b)) {
    ...
    function Ga(b, a, c, d) {
        ...
        if (a) {
            ...
            if (M(b))for (var f =
                a.length = 0; f < b.length; f++)e = Ga(b[f], null, c, d), S(b[f]) && (c.push(b[f]), d.push(e)), a.push(e); else {
                var g = a.$$hashKey;
                M(a) ? a.length = 0 : r(a, function (b, c) {
                    delete a[c]
                });
                for (f in b)b.hasOwnProperty(f) && (e = Ga(b[f], null, c, d), S(b[f]) && (c.push(b[f]), d.push(e)), a[f] = e);
                cc(a, g)
            }
        } else if (a = b)M(b) ? a = Ga(b, [], c, d) : ha(b) ? a = new Date(b.getTime()) : db(b) ? (a = new RegExp(b.source, b.toString().match(/[^\/]*$/)[0]), a.lastIndex = b.lastIndex) : S(b) && (e = Object.create(Object.getPrototypeOf(b)), a = Ga(b, e, c, d));
        return a
    }
    ...
    function qa(b,
        ...
        } else if (S(b))for (c in a = a || {}, b)if ("$" !== c.charAt(0) || "$" !== c.charAt(1))a[c] = b[c];
        return a || b
    }
    ...
    function ra(b, a) {
        ...
        if (c == typeof a && "object" == c)if (M(b)) {
            ...
            if (ha(b))return ha(a) ? ra(b.getTime(), a.getTime()) : !1;
            if (db(b) && db(a))return b.toString() == a.toString();
            if (Qa(b) || Qa(a) || Oa(b) || Oa(a) || M(a))return !1;
            c = {};
    ...
    function wd(b, a) {
        var c, d, e = hb.length;
        b = D(b);
        for (d = 0; d < e; ++d)if (c = hb[d] + a, C(c = b.attr(c)))return c;
        return null
    }
    ...
    function Bd() {
        ...
        jc || ((ma = O.jQuery) && ma.fn.on ? (D = ma, v(ma.fn, {
            ...
            var c;
            if (Eb)Eb = !1; else for (var d = 0, e; null != (e = a[d]); d++)(c = ma._data(e, "events")) && c.$destroy && ma(e).triggerHandler("$destroy");
            b(a)
    ...
    function Dd(b) {
        ...
        Va("ng", ["ngLocale"], ["$provide", function (a) {
            ...
            a.provider("$compile", lc).directive({
                ...
                ngValue: me,
                ngModelOptions: ne
            }).directive({ngInclude: oe}).directive(mb).directive(rc);
            a.provider({
                $anchorScroll: pe,
                $animate: qe,
                $browser: re,
    ...
    function T(b) {
        ...
        if (!(this instanceof T)) {
            if (a && "<" != b.charAt(0))throw Hb("nosel");
            return new T(b)
        }
        if (a) {
            a = Y;
    ...
    function pb(b, a) {
        ...
        a && !c && (b.ng339 = c = ++Ve, c = qb[c] = {events: {}, data: {}, handle: s});
        return c
    }
    ...
    function rb(b, a, c) {
        ...
        for (a = M(a) ? a : [a]; b;) {
            for (var d = 0, e = a.length; d < e; d++)if ((c = D.data(b, a[d])) !== s)return c;
    ...
    function Mb(b, a, c) {
        ...
        if ("function" === typeof b) {
            if (!(d = b.$inject)) {
                d = [];
                if (b.length) {
                    if (a)throw C(c) && c || (c = b.name || Ye(b)), Ka("strictdi", c);
        ...
        } else M(b) ? (a = b.length - 1, ib(b[a], "fn"), d = b.slice(0, a)) :
            ib(b, "fn", !0);
        return d
    }
    ...
    function Cb(b, a) {
        function c(a) {
            return function (b, c) {
                if (S(b))r(b, bc(a)); else return a(b, c)
            }
        }

        function d(a, b) {
            Ia(a, "service");
            if (F(b) || M(b))b = p.instantiate(b);
        ...
        function g(b, c) {
            function d(a) {
                if (b.hasOwnProperty(a)) {
                    if (b[a] === h)throw Ka("cdep", a + " <- " + k.join(" <- "));
                    return b[a]
                }
                try {
            ...
            function e(b,
                ...
                for (k = g.length; l < k; l++) {
                    m = g[l];
                    if ("string" !== typeof m)throw Ka("itkn", m);
            ...
            return {
                invoke: e, instantiate: function (a, b, c) {
                    ...
                    a = e(a, d, b, c);
                    return S(a) || F(a) ? a : d
                }, get: d, annotate: Mb, has: function (a) {
    ...
    function af(b, a, c, d) {
        ...
        h.url = function (a, c) {
            ...
            if (a) {
                if (y != a)return y = a, d.history ? c ? n.replaceState(null, "", a) : (n.pushState(null, "", a), E.attr("href", E.attr("href"))) :
                    (G = a, c ? l.replace(a) : l.href = a), h
            } else return G || l.href.replace(/%27/g, "'")
        };
        var B = [], X = !1;
        ...
        h.cookies = function (a, b) {
            var d, e, f, g;
            if (a)b === s ? k.cookie = encodeURIComponent(a) + "=;path=" + P + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" :
            C(b) && (d = (k.cookie = encodeURIComponent(a) + "=" + encodeURIComponent(b) + ";path=" + P).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!")); else {
                if (k.cookie !== L)for (L = k.cookie, d = L.split("; "), K = {}, f = 0; f < d.length; f++)e = d[f], g = e.indexOf("="), 0 < g && (a = decodeURIComponent(e.substring(0, g)), K[a] === s && (K[a] = decodeURIComponent(e.substring(g + 1))));
                return K
            }
        };
    ...
    function se() {
        this.$get = function () {
            function b(b, d) {
                ...
                if (b in a)throw Q("$cacheFactory")("iid", b);
                var g = 0, h = v({}, d, {id: b}), k = {}, l = d && d.capacity || Number.MAX_VALUE, n = {}, p = null, q = null;
                return a[b] = {
                    put: function (a, b) {
        ...
        this.directive = function n(a,
            ...
            C(a) ? (Fb(e, "directiveFactory"), d.hasOwnProperty(a) || (d[a] = [], b.factory(a + "Directive", ["$injector", "$exceptionHandler", function (b, e) {
                ...
                r(d[a], function (d, g) {
                    try {
                        var h = b.invoke(d);
                        F(h) ? h = {compile: ga(h)} : !h.compile && h.link && (h.compile = ga(h.link));
            ...
            function (a, b, c, m, t, u, H, A, y, E, G) {
                ...
                function X(a, b, c, d, e) {
                    ...
                    return function (b, c, d, e, m) {
                        ...
                        m = c ? Ha.clone.call(g) :
                            g;
                        if (d)for (var q in d)m.data("$" + q + "Controller", d[q].instance);
                        X.$$addScopeInfo(m, b);
                        c && c(m, b);
                        f && f(b, m, m, e);
                        return m
                ...
                function K(a, b, c, d, e, f) {
                    function h(a, c, d, e) {
                        var f, k, m, q, n, p, y;
                        if (u)for (y = Array(c.length), q = 0; q < g.length; q += 3)f = g[q], y[f] = c[f]; else y = c;
                        q = 0;
                        for (n = g.length; q < n;)k = y[g[q++]], c = g[q++], f = g[q++], c ? (c.scope ? (m = a.$new(), X.$$addScopeInfo(D(k), m)) : m = a, p = c.transcludeOnThisElement ? L(a, c.transclude, e, c.elementTranscludeOnThisElement) : !c.templateOnThisElement && e ? e : !e && b ? L(a, b) : null, c(f, m, k, d, p)) :
                ...
                function P(b, c, g, h, k) {
                    ...
                    switch (b.nodeType) {
                        case 1:
                            ...
                            for (var u, p, y, t = b.attributes, E = 0, H = t && t.length; E < H; E++) {
                                ...
                                if (!aa || 8 <= aa || u.specified) {
                                    ...
                                    u = ca(u.value);
                                    p = va(q);
                                    if (y = ka.test(p))q = Db(p.substr(6), "-");
                                    var A = p.replace(/(Start|End)$/, ""), r;
                                    a:{
                                        var U = A;
                                        if (d.hasOwnProperty(U)) {
                                            r = void 0;
                                            for (var U = a.get(U + "Directive"), N = 0, B = U.length; N < B; N++)if (r = U[N], r.multiElement) {
                                                r = !0;
                                                break a
                                            }
                                        }
                                    ...
                                    p = va(q.toLowerCase());
                                    m[p] = q;
                                    if (y || !g.hasOwnProperty(p))g[p] = u, Ac(b, p) && (g[p] = !0);
                                    V(b, c, u, p, y);
                                    $(c, p, "A", h, k, K, G)
                                }
                            }
                            b = b.className;
                            if (C(b) && "" !== b)for (; q = f.exec(b);)p = va(q[2]), $(c, p, "C", h, k) && (g[p] = ca(q[3])), b = b.substr(q.index + q[0].length);
                            break;
                        case 3:
                            O(c, b.nodeValue);
                            break;
                        case 8:
                            try {
                                if (q = e.exec(b.nodeValue))p = va(q[1]), $(c, p, "M", h, k) && (g[p] = ca(q[2]))
                            } catch (P) {
                            }
                    }
                    c.sort(w);
                ...
                function U(a, d, e, f, g, h, k, m, n) {
                    function y(a, b, c, d) {
                        if (a) {
                            ...
                            a.require = I.require;
                            a.directiveName = ka;
                            if (B === I || I.$$isolateScope)a = Fc(a, {isolateScope: !0});
                            k.push(a)
                        }
                        if (b) {
                            c && (b = N(b, c, d));
                            b.require = I.require;
                            b.directiveName = ka;
                            if (B === I || I.$$isolateScope)b = Fc(b, {isolateScope: !0});
                            m.push(b)
                        }
                    }
                    ...
                    function H(a, c, f, g, h) {
                        ...
                        g = 0;
                        for (n = k.length; g < n; g++)y = k[g], Gc(y, y.isolateScope ? ua : c, P, J, y.require && E(y.directiveName, y.require, P, G), N);
                        g = c;
                        B && (B.template || null === B.templateUrl) && (g = ua);
                        a && a(g, f.childNodes, s, h);
                        for (g = m.length - 1; 0 <= g; g--)y = m[g], Gc(y, y.isolateScope ? ua : c, P, J, y.require && E(y.directiveName, y.require, P, G), N)
                    }
                    ...
                    for (var K = -Number.MAX_VALUE, G, A = n.controllerDirectives, U, B = n.newIsolateScopeDirective, L = n.templateDirective, $ = n.nonTlbTranscludeDirective, z = !1, V = !1, w = n.hasElementTranscludeDirective,
                             v = e.$$element = D(d), I, ka, W, ya = f, O, R = 0, xa = a.length; R < xa; R++) {
                        I = a[R];
                        var T = I.$$start, Pb = I.$$end;
                        T && (v = J(d, T, Pb));
                        W = s;
                        if (K > I.priority)break;
                        if (W = I.scope)I.templateUrl || (S(W) ? (Q("new/isolated scope", B || G, I, v), B = I) : Q("new/isolated scope", B, I, v)), G = G || I;
                        ka = I.name;
                        !I.templateUrl && I.controller && (W = I.controller, A = A || {}, Q("'" + ka + "' controller", A[ka], I, v), A[ka] = I);
                        if (W = I.transclude)z = !0, I.$$tlb || (Q("transclusion", $, I, v), $ = I), "element" == W ? (w = !0, K = I.priority, W = v, v = e.$$element = D(Y.createComment(" " + ka + ": " + e[ka] +
                        " ")), d = v[0], fa(g, Ta.call(W, 0), d), ya = X(W, f, K, h && h.name, {nonTlbTranscludeDirective: $})) : (W = D(Ib(d)).contents(), v.empty(), ya = X(W, f));
                        if (I.template)if (V = !0, Q("template", L, I, v), L = I, W = F(I.template) ? I.template(v, e) : I.template, W = Z(W), I.replace) {
                            h = I;
                            W = Gb.test(W) ? D(Nb(I.templateNamespace, ca(W))) : [];
                            d = W[0];
                            if (1 != W.length || 1 !== d.nodeType)throw ja("tplrt", ka, "");
                            fa(g, v, d);
                            xa = {$attr: {}};
                            W = P(d, [], xa);
                        ...
                        if (I.templateUrl)V = !0, Q("template", L, I, v), L = I, I.replace && (h = I), H = bf(a.splice(R, a.length - R), v, e, g, z && ya, k, m, {
                            controllerDirectives: A,
                            newIsolateScopeDirective: B,
                            templateDirective: L,
                            nonTlbTranscludeDirective: $
                        }), xa = a.length; else if (I.compile)try {
                ...
                function $(b, e, f, g, h, k, m) {
                    ...
                    if (d.hasOwnProperty(e)) {
                        var u;
                        e = a.get(e + "Directive");
                        for (var p = 0, y = e.length; p < y; p++)try {
                ...
                function bf(a, b, c, d, e, f, g, h) {
                    ...
                    m(y.getTrustedResourceUrl(E)).then(function (m) {
                        ...
                        if (p.replace) {
                            ...
                            y = m[0];
                            if (1 != m.length || 1 !== y.nodeType)throw ja("tplrt", p.name, E);
                            m = {$attr: {}};
                            fa(d, b, y);
                            var A = P(y, [], m);
                            S(p.scope) && tb(A);
                ...
                function Q(a, b, c, d) {
                    if (b)throw ja("multidir", b.name, c.name, a, ta(d));
                }
                ...
                function V(a, c, d, e, f) {
                    var k = b(d, !0);
                    if (k) {
                        if ("multiple" === e && "select" === pa(a))throw ja("selmulti", ta(a));
                        c.push({
                            priority: 100, compile: function () {
                                return {
                                    pre: function (c, d, m) {
                                        d = m.$$observers || (m.$$observers = {});
                                        if (h.test(e))throw ja("nodomevents");
                                        if (k = b(m[e], !0, xa(a, e), g[e] || f))m[e] = k(c), (d[e] || (d[e] = [])).$$inter = !0, (m.$$observers && m.$$observers[e].$$scope || c).$watch(k, function (a, b) {
                ...
                function fa(a, b, c) {
                    ...
                    if (a)for (g = 0, h = a.length; g < h; g++)if (a[g] ==
                        d) {
                        a[g++] = c;
                        h = g + e - 1;
                ...
                Ob.prototype = {
                    $normalize: va, $addClass: function (a) {
                        ...
                        g = pa(this.$$element);
                        if ("a" === g && "href" === a || "img" === g && "src" === a)this[a] = b = G(b, "src" === a);
    ...
    function te() {
        ...
        this.$get = ["$injector", "$window", function (d, e) {
            ...
            return function (g, h, k, l) {
                ...
                }, k.prototype = (M(g) ? g[g.length - 1] : g).prototype, n = new k, q && f(h, q, n, p || g.name), v(function () {
                    d.invoke(g, n, h, p);
                    return n
    ...
    function ye() {
        var b = /^\s*(\[|\{[^\{])/, a = /[\}\]]\s*$/, c = /^\)\]\}',?\n/, d = {"Content-Type": "application/json;charset=utf-8"},
            e = this.defaults = {
                ...
                headers: {common: {Accept: "application/json, text/plain, */*"}, post: qa(d), put: qa(d), patch: qa(d)},
        ...
        this.$get = ["$httpBackend", "$browser",
            "$cacheFactory", "$rootScope", "$q", "$injector", function (a, b, c, d, p, q) {
                function m(a) {
                    function b(a) {
                        var d = v({}, a, {data: Kc(a.data, a.headers, c.transformResponse)});
                        a = a.status;
                    ...
                    var c = {
                        ...
                        a:for (d in b) {
                            a = R(d);
                            for (f in c)if (R(f) === a)continue a;
                            c[d] = b[d]
                        }
                        (function (a) {
                            var b;
                ...
                function t(c, g, l) {
                    ...
                    if (J)if (N = J.get(U), x(N)) {
                        if (N && F(N.then))return N.then(A, A), N;
    ...
    function df(b) {
        if (8 >= aa && (!b.match(/^(get|post|head|put|delete|options)$/i) || !O.XMLHttpRequest))return new O.ActiveXObject("Microsoft.XMLHTTP");
    ...
    function ef(b, a, c, d, e) {
        ...
        return function (e, h, k, l, n, p, q, m) {
            ...
            if (0 < p)var B = c(t, p); else p && F(p.then) && p.then(t)
        }
    }
    ...
    function we() {
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce", function (c, d, e) {
            ...
            function g(f, g, m, t) {
                ...
                s;)if (-1 != (A = f.indexOf(b, E)) && -1 != (y = f.indexOf(a, A + h)))E !== A && K.push(u(f.substring(E, A))), E = f.substring(A + h, y), G.push(E), r.push(c(E, H)), E = y + k, L.push(K.length), K.push(""); else {
                    E !== s && K.push(u(f.substring(E)));
                    break
                }
                if (m && 1 < K.length)throw Qb("noconcat", f);
                if (!g || G.length) {
                    var P = function (a) {
                    ...
                    return v(function (a) {
                        ...
                        exp: f, expressions: G, $$watchDelegate: function (a, b, c) {
                            var d;
    ...
    function Ae() {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", function (c, d, e, f) {
            ...
            if (a.enabled) {
                if (!k && a.requireBase)throw ub("nobase");
            ...
            f.on("click", function (a) {
                if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
                    for (var b = D(a.target); "a" !== pa(b[0]);)if (b[0] === f[0] || !(b = b.parent())[0])return;
    ...
    function Sc(b, a, c) {
        ...
        if (a.csp)d = 6 > f ? Rc(e[0], e[1], e[2], e[3], e[4], c) : function (a, b) {
            var d = 0, g;
            do g = Rc(e[d++], e[d++], e[d++], e[d++], e[d++], c)(a, b), b = s, a = g; while (d < f);
            return g
        }; else {
            var g = "";
            r(e, function (a, b) {
    ...
    function De() {
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", "$browser", function (e, f, g, h) {
            ...
            function l(b) {
                if (t.$$phase)throw a("inprog", t.$$phase);
                t.$$phase =
                    b
            }
            ...
            function q() {
                for (var a = t.$$applyAsyncQueue; a.length;)try {
                    a.shift()()
                } catch (b) {
                    f(b)
                }
            ...
            k.prototype = {
                constructor: k, $new: function (a) {
                    ...
                    function c(a) {
                        e = a;
                        var b, d, g, h;
                        if (S(e))if (Na(e))for (f !== m && (f = m, r = f.length = 0, l++), a = e.length, r !== a && (l++, f.length = r = a), b = 0; b < a; b++)h = f[b], g = e[b], d = h !== h && g !== g, d || h === g || (l++, f[b] = g); else {
                            f !== p && (f = p = {}, r = 0, l++);
                            a = 0;
                    ...
                    return this.$watch(n, function () {
                        ...
                        } else for (a in h = {}, e)Ab.call(e, a) && (h[a] = e[a]); else h = e
                    })
                }, $digest: function () {
                    ...
                    do {
                        ...
                        a:do {
                            if (n = L.$$watchers)for (B = n.length; B--;)try {
                                if (e = n[B])if ((g = e.get(L)) !== (k = e.last) && !(e.eq ? ra(g, k) : "number" === typeof g && "number" === typeof k && isNaN(g) && isNaN(k)))s = !0, c = e, e.last = e.eq ? Ga(g, null) : g, e.fn(g, k === p ? g : k, L), 5 > K && (J = 4 - K, P[J] || (P[J] = []), N = F(e.exp) ? "fn: " + (e.exp.name || e.exp.toString()) : e.exp, N += "; newVal: " + sa(g) + "; oldVal: " + sa(k), P[J].push(N)); else if (e === c) {
                                    s = !1;
                                    break a
                                }
                            } catch (x) {
                            ...
                            if (!(n = L.$$childHead || L !== this && L.$$nextSibling))for (; L !==
                                                                                             this && !(n = L.$$nextSibling);)L = L.$parent
                        } while (L = n);
                        if ((s || m.length) && !K--)throw t.$$phase = null, a("infdig", b, sa(P));
                    } while (s || m.length);
                    for (t.$$phase = null; r.length;)try {
                        r.shift()()
                    } catch (D) {
                        f(D)
                    }
                    ...
                    for (var g = fb([e], arguments, 1), h, k; c = d;) {
                        ...
                        if (!(d = c.$$listenerCount[a] && c.$$childHead || c !== this && c.$$nextSibling))for (; c !== this && !(d = c.$$nextSibling);)c =
                            c.$parent
                    }
                    e.currentScope = null;
                    return e
    ...
    function Ge() {
        ...
        this.$get = ["$parse", "$sniffer", "$sceDelegate", function (a, c, d) {
            if (b && c.msie && 8 > c.msieDocumentMode)throw Ba("iequirks");
            var e = qa(la);
        ...
        this.$get = ["$window", "$document", function (b, a) {
            ...
            return {
                ...
                4 > d || e), hashchange: "onhashchange"in b && (!g || 7 < g), hasEvent: function (a) {
                    if ("input" == a && 9 == aa)return !1;
                    if (w(c[a])) {
                        var b = f.createElement("div");
                        c[a] = "on" + a in b
                    }
                    return c[a]
                }, csp: Ua(), vendorPrefix: h, transitions: n, animations: p, android: d, msie: aa, msieDocumentMode: g
            }
        }]
    }
    ...
    function ad(b,
        ...
        if (l)0 < e && -1 < b && 1 > b && (h = b.toFixed(e)); else {
            ...
            if (g.length >= p + q)for (n = g.length - p, l = 0; l < n; l++)0 ===
    ...
    function Yc(b) {
        ...
        return function (c, e, f) {
            ...
            ea(c) && (c = new Date(c));
            if (!ha(c))return c;
            for (; e;)(l = of.exec(e)) ? (h = fb(h, l, 1), e = h.pop()) : (h.push(e), e = null);
    ...
    function bb(b, a, c, d) {
        return function (e, f, g, h, k, l, n) {
            ...
            h.$parsers.push(function (b) {
                if (h.$isEmpty(b))return null;
                if (a.test(b)) {
                    var d = h.$modelValue;
                    if (d && "UTC" === q)var e = 6E4 * d.getTimezoneOffset(), d = new Date(d.getTime() + e);
                    b = c(b, d);
    ...
    function hd(b, a, c, d,
        ...
        if (x(d)) {
            b = b(d);
            if (!b.constant)throw Q("ngModel")("constexpr", c, d);
            return b(a)
        }
        return e
    }
    ...
    var M = Array.isArray, ca = function (b) {
        ...
        if (x(Ua.isActive_))return Ua.isActive_;
    ...
    var Ha = T.prototype = {
        ...
        }, length: 0, push: uf, sort: [].sort, splice: [].splice
    }, sb = {};
    ...
    var Cc = {ngMinlength: "minlength", ngMaxlength: "maxlength", ngMin: "min", ngMax: "max", ngPattern: "pattern"};
    r({data: Jb, removeData: ob},
        function (b, a) {
            T[a] = b
        });
    r({
        data: Jb, inheritedData: rb, scope: function (b) {
        ...
        }, controller: xc, injector: function (b) {
            return rb(b, "$injector")
        }, removeAttr: function (b, a) {
            b.removeAttribute(a)
        }, hasClass: lb, css: function (b, a, c) {
            a = Wa(a);
            if (x(c))b.style[a] = c; else return b.style[a]
        }, attr: function (b, a, c) {
            var d = R(a);
            if (sb[d])if (x(c))c ? (b[a] = !0, b.setAttribute(a,
                d)) : (b[a] = !1, b.removeAttribute(d)); else return b[a] || (b.attributes.getNamedItem(a) || z).specified ? d : s; else if (x(c))b.setAttribute(a, c); else if (b.getAttribute)return b = b.getAttribute(a, 2), null === b ? s : b
        }, prop: function (b, a, c) {
        ...
        T.prototype[a] = function (a, d) {
            ...
            if (b !== yc && (2 == b.length && b !== lb && b !== xc ? a : d) === s) {
                if (S(a)) {
                    for (e = 0; e < g; e++)if (b === Jb)b(this[e], a); else for (f in a)b(this[e], f, a[f]);
                    return this
                }
                e = b.$dv;
    ...
    r({
        ...
        T.prototype[c] = function (c, e, f) {
            for (var g, h = 0, k = this.length; h < k; h++)w(g) ? (g = a(this[h], c, e, f), x(g) && (g = D(g))) : vc(g, a(this[h], c, e, f));
            return x(g) ? g : this
        };
    ...
    Pc.prototype = Tb.prototype = Oc.prototype = {
        $$html5: !1, $$replace: !1, absUrl: vb("$$absUrl"), url: function (a) {
            ...
            "");
            return this
        }, protocol: vb("$$protocol"), host: vb("$$host"), port: vb("$$port"), path: Qc("$$path", function (a) {
            a = a ? a.toString() : "";
            ...
            switch (arguments.length) {
                case 0:
                    return this.$$search;
                case 1:
                    if (C(a) || ea(a))a = a.toString(), this.$$search = hc(a); else if (S(a))r(a, function (c, e) {
                        null == c && delete a[e]
                    }), this.$$search = a; else throw ub("isrcharg");
                    break;
                default:
    ...
    }), Bf = {n: "\n", f: "\f", r: "\r", t: "\t", v: "\v", "'": "'", '"': '"'}, Vb = function (a) {
        this.options = a
    };
    Vb.prototype = {
        constructor: Vb, lex: function (a) {
            this.text = a;
            this.index = 0;
            this.ch = s;
            for (this.tokens = []; this.index < this.text.length;)if (this.ch =
                    this.text.charAt(this.index), this.is("\"'"))this.readString(this.ch); else if (this.isNumber(this.ch) || this.is(".") && this.isNumber(this.peek()))this.readNumber(); else if (this.isIdent(this.ch))this.readIdent(); else if (this.is("(){}[].,;:?"))this.tokens.push({
                index: this.index,
                text: this.ch
            }), this.index++; else if (this.isWhitespace(this.ch))this.index++; else {
                a = this.ch + this.peek();
                var c = a + this.peek(2), d = Yb[this.ch], e = Yb[a], f = Yb[c];
                f ? (this.tokens.push({index: this.index, text: c, fn: f}), this.index += 3) : e ? (this.tokens.push({
                    index: this.index,
                    text: a, fn: e
            ...
            this.tokens.push({index: d, text: c, fn: kd[c] || Sc(c, this.options, a)});
            ...
            for (var d = "", e = a, f = !1; this.index < this.text.length;) {
                ...
                if (f)"u" === g ? (f = this.text.substring(this.index + 1, this.index + 5), f.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + f + "]"), this.index += 4, d += String.fromCharCode(parseInt(f, 16))) : d += Bf[g] || g, f = !1; else if ("\\" === g)f = !0; else {
                    if (g === a) {
                        this.index++;
                        this.tokens.push({
    ...
    Za.prototype = {
        constructor: Za, parse: function (a) {
            this.text = a;
        ...
        peek: function (a, c, d, e) {
            ...
            return v(function (c, h) {
                ...
                return d(k)
            }, {constant: !d.$stateful && c.every(Ub), inputs: !d.$stateful && c})
        }, expression: function () {
            ...
            if (c = this.expect("&&"))a = this.binaryFn(a, c.fn,
                this.logicalAND(), !0);
            return a
        }, equality: function () {
            ...
            return function (g, h) {
                ...
                if (f)for (var n = d.length; n--;)f[n] = Aa(d[n](g, h), e);
                Aa(k, e);
                if (l) {
                    if (l.constructor === l)throw oa("isecfn",
                        e);
                    if (l === yf || l === zf || l === Af)throw oa("isecff", e);
                }
            ...
            return v(function (c, e) {
                ...
                return f
            }, {literal: !0, constant: a.every(Ub), inputs: a})
        }, object: function () {
            var a = [], c = [];
            if ("}" !== this.peekToken().text) {
                do {
            ...
            return v(function (d, f) {
                ...
                return g
            }, {literal: !0, constant: c.every(Ub), inputs: c})
        }
    };
    ...
    var ld = function (a) {
            return ["$timeout", function (c) {
                return {
                    name: "form", restrict: a ? "EAC" : "E", controller: ed, compile: function () {
                        return {
        ...
        Ef = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, md = /^(\d{4})-(\d{2})-(\d{2})$/, nd = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Zb = /^(\d{4})-W(\d\d)$/, od = /^(\d{4})-(\d\d)$/, pd = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Ff = /(\s+|^)default(\s+|$)/, $b = new Q("ngModel"), qd = {
            ...
            return {
                restrict: "E",
                require: ["?ngModel"], link: function (f, g, h, k) {
            ...
            this.$$setOptions = function (a) {
                m.$options = a;
                if (!(p.assign || a && a.getterSetter))throw $b("nonassign", d.ngModel, ta(e));
            };
            this.$render =
                z;
            ...
            this.$$runValidators = function (a, c, d, e) {
                ...
                function g() {
                    ...
                    r(m.$asyncValidators, function (f, g) {
                        var k =
                            f(c, d);
                        if (!k || !F(k.then))throw $b("$asyncValidators", k);
                        h(g, s);
                ...
                (function (a) {
                    ...
                    if (a === s)h(c, null); else if (h(c, a), !a)return r(m.$validators, function (a, c) {
                        h(c, null)
            ...
            this.$commitViewValue = function () {
                var a =
                    m.$viewValue;
                h.cancel(q);
                if (m.$$lastCommittedViewValue !== a || "" === a && m.$$hasNativeValidators)m.$$lastCommittedViewValue = a, m.$pristine && (m.$dirty = !0, m.$pristine = !1, g.removeClass(e, Ma), g.addClass(e, yb), H.$setDirty()), this.$$parseAndValidate()
            };
            this.$$parseAndValidate = function () {
                for (var a = !0, c = m.$$lastCommittedViewValue, d = c, e = 0; e < m.$parsers.length; e++)if (d = m.$parsers[e](d), w(d)) {
                    a = !1;
                    break
                }
            ...
            return {
                ...
                controller: Gf, link: {
                    pre: function (a, c, d, e) {
                        ...
                        var f = e[0];
                        if (f.$options && f.$options.updateOn)c.on(f.$options.updateOn, function (a) {
                ...
                restrict: "A", require: "?ngModel", link: function (a, c, d, e) {
                    if (e) {
                        ...
                        d.$observe("pattern", function (a) {
                            ...
                            if (a && !a.test)throw Q("ngPattern")("noregexp",
                                g, a, ta(c));
                            f = a || s;
                            e.$validate()
                        });
    ...
    var Xd = ["$animate", function (a) {
    ...
    }), $d = Ea({terminal: !0, priority: 1E3}), ae = ["$locale", "$interpolate", function (a, c) {
        var d = /{}/g;
        return {
            ...
            compile: function (f, g) {
                ...
                return function (a, f, g, m, l) {
                    ...
                    a.$watchCollection(p, function (g) {
                        ...
                        q && (a[q] = g);
                        if (Na(g))G = g, p = A || y; else {
                            p = A || E;
                            G = [];
                            for (fa in g)g.hasOwnProperty(fa) && "$" != fa.charAt(0) && G.push(fa);
                            G.sort()
                        }
                        L = G.length;
                        fa = Array(L);
                        for (m = 0; m < L; m++)if (z = g === G ? m : G[m], H = g[z], w = p(z, H, m), n[w])V = n[w], delete n[w], v[w] = V, fa[m] = V; else {
                            if (v[w])throw r(fa, function (a) {
                                a && a.scope && (n[a.id] = a)
                            }), d("dupes", h, w, sa(H));
                            fa[m] = {id: w, scope: s, clone: s};
                            v[w] = !0
                        }
                        for (x in n) {
                            V = n[x];
                            w = jb(V.clone);
                            c.leave(w);
                            if (w[0].parentNode)for (m = 0, p = w.length; m < p; m++)w[m].$$NG_REMOVED = !0;
                            V.scope.$destroy()
                        }
                        for (m = 0; m < L; m++)if (z = g === G ? m : G[m], H = g[z], V = fa[m], V.scope) {
                            x =
                                K;
        ...
        return {
            restrict: "A",
            multiElement: !0, link: function (c, d, e) {
        ...
        restrict: "EAC", link: function (a, c, d, e, f) {
            if (!f)throw Q("ngTransclude")("orphan", ta(c));
            f(function (a) {
                c.empty();
                c.append(a)
            })
    ...
    }], Jf = Q("ngOptions"), he = ga({restrict: "A", terminal: !0}), Kd = ["$compile", "$parse", function (a, c) {
            ...
            link: function (e,
                ...
                function p(e, f, g) {
                    ...
                    function k() {
                        ...
                        B = {};
                        C = !1;
                        if (m)if (h = g.$modelValue, w && M(h))for (C = new Xa([]), d = {}, t = 0; t < h.length; t++)d[n] = h[t], C.put(w(e, d), h[t]); else C = new Xa(h);
                        t = C;
                        var F, J;
                        for (C = 0; H = G.length, C < H; C++) {
                            ...
                            F = p(e, B);
                            F = x(F) ? F : "";
                            h.push({id: w ? w(e, B) : q ? G[C] : C, label: F, selected: d})
                        }
                        ...
                        for (G = c.length; B < G; B++) {
                            ...
                            F = null;
                            C = 0;
                            for (H = h.length; C < H; C++)d = h[C], (t = s[C + 1]) ? (F = t.element, t.label !== d.label && F.text(t.label = d.label), t.id !== d.id && F.val(t.id = d.id), F[0].selected !== d.selected && (F.prop("selected", t.selected = d.selected), aa && F.prop("selected", t.selected))) : ("" === d.id && u ? J = u : (J = y.clone()).val(d.id).prop("selected", d.selected).attr("selected", d.selected).text(d.label), s.push({
                                element: J,
                                label: d.label,
                                id: d.id,
                                selected: d.selected
                            }), F ? F.after(J) : l.element.append(J), F = J);
                            for (C++; s.length > C;)s.pop().element.remove()
                        }
                        for (; D.length >
                               B;)D.pop()[0].element.remove()
                    }

                    var l;
                    if (!(l = t.match(d)))throw Jf("iexp", t, ta(f));
                    ...
                    f.on("change", function () {
                        e.$apply(function () {
                            ...
                            if (m)for (l = [], r = 0, x = D.length; r < x; r++)for (a = D[r], p = 1, t = a.length; p < t; p++) {
                                if ((h = a[p].element)[0].selected) {
                                    h = h.val();
                                    q && (d[q] = h);
                                    if (w)for (u = 0; u < c.length &&
                                    (d[n] = c[u], w(e, d) != h); u++); else d[n] = c[h];
                                    l.push(v(e, d))
                                }
                            } else if (h = f.val(), "?" == h)l = s; else if ("" === h)l = null; else if (w)for (u = 0; u < c.length; u++) {
                                if (d[n] = c[u], w(e, d) == h) {
                                    l = v(e, d);
                                    break
                                }
                            } else d[n] = c[h], q && (d[q] = h), l = v(e, d);
                            g.$setViewValue(l);
                            k()
                        })
                    });
                    ...
                    e.$watchCollection(function () {
                        var a = {}, c = z(e);
                        if (c) {
                            for (var d = Array(c.length), f = 0, g = c.length; f < g; f++)a[n] = c[f], d[f] = p(e, a);
                            return d
                        }
                    }, h);
                ...
                if (k[1]) {
                    ...
                    h = 0;
                    for (var B = g.children(), C = B.length; h < C; h++)if ("" === B[h].value) {
                        v = u = B.eq(h);
                        break
                    }
                    q.init(k, u, z);
