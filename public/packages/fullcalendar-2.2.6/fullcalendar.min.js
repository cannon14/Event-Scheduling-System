...
(function (t) {
    ...
    function me(n, r) {
        ...
        function f(n) {
            ...
            var r, s, l, a, u, d = J.defaultButtonText || {}, c = J.buttonText || {}, h = J.views || {}, f = n, g = [], p = !1;
            if (fe[n])return fe[n];
        ...
        var ne, ie, re, se, oe, le, ae, ue, de = K.isFetchNeeded, ce = K.fetchEvents, he = n[0], fe = {}, ge = 0, pe = [];
    ...
    }, De = t.fullCalendar = {version: "2.2.6"}, Ce = De.views = {};
    ...
    var qe = De.View = K.extend({
        ...
        massageCurrentDate: function (t, n) {
            return this.intervalDuration <= e.duration({days: 1}) && this.isHiddenDay(t) && (t = this.skipHiddenDays(t, n), t.startOf("day")), t
        },
